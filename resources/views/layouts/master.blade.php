...
<button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 dark:hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-gray-200">
       ...
       <ul class="space-y-2 font-medium">
          <li>
             <a href="{{route('admin.dashboard')}}" class="nav-link flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 dark:hover:bg-zinc-700 group">
                ...
                <span class="ml-3 text-zinc-900 dark:text-white">Dashboard</span>
             </a>
          </li>
          <li>
          ...
          <li>
             <a href="{{route('quiz.list')}}" class="nav-link flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 dark:hover:bg-zinc-700 group">
