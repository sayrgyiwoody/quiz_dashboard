        ...
        <tbody>
            ...
            <tr class="text-zinc-900 dark:text-white bg-white border-b dark:bg-zinc-800 dark:border-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-600">
                ...
                <th scope="row" class=" text-gray-900 whitespace-nowrap dark:text-white">
                    ...
                    @elseif($admin->provider_avatar && $admin->profile_photo_path === null)
                        <img class="w-10 h-10 rounded-full object-cover" src="{{$admin->provider_avatar}}" alt="Jese image">
                    @else
                ...
                <td class="px-6 py-4">
                   ...
                   <div class="flex items-center">
                    ...
                    <button data-modal-target="default-modal" data-modal-toggle="default-modal" type="button" class="ms-2 bg-red-500 p-2 rounded hover:bg-red-700 duration-100 btn-delete">
